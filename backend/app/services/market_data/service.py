...
class MarketDataService:
    ...
    def __init__(
        ...
        # Fallback provider if real provider suffers connectivity outage
    ...
    async def get_current_price(
        ...
        try:
            ...
            logger.warning("Primary provider '%s' failed for %s (%s). Using fallback.", self.provider.name, clean_symbol, exc)
    ...
    async def get_ohlcv(
        ...
        try:
            ...
            logger.warning("Primary provider failed for %s OHLCV: %s. Using fallback.", clean_symbol, exc)
    ...
    async def get_orderbook(self, symbol: str, depth: int = 20) -> CanonicalOrderBook:
        ...
        try:
            ...
            logger.warning("Primary provider failed for %s orderbook: %s. Using fallback.", clean_symbol, exc)
    ...
    async def get_volume(self, symbol: str) -> CanonicalVolume:
        ...
        try:
            ...
            logger.warning("Primary provider failed for %s volume: %s. Using fallback.", clean_symbol, exc)
    ...
    async def get_market_overview(self) -> CanonicalMarketOverview:
        ...
        try:
            ...
            logger.warning("Primary provider overview failed: %s. Using fallback.", exc)
